# Generated by Django 4.0.3 on 2022-03-25 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999.9'}}, help_text='Maximum 999.9', max_digits=5, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999.9'}}, help_text='Maximum 999.9', max_digits=5, verbose_name='Discount Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, help_text='Please add alternative text', max_length=255, null=True, verbose_name='Alturnative text')),
