...
class Category(MPTTModel):
    ...
    slug = models.CharField(verbose_name=_("Category safe URL"), max_length=255, unique=True)
...
class ProductType(models.Model):
    """
    ProducType Table will provide a list of the different types of products that are for sale
    """
...
class ProductSpecification(models.Model):
    """The ProductSpecification Table contains product specification
    or features for the product type"""

    product_type = models.ForeignKey(ProductType, on_delete=models.RESTRICT)
    name = models.CharField(verbose_name=_("Name"), help_text=("Required"), max_length=255)
...
class Product(models.Model):
    ...
    regular_price = models.DecimalField(
        ...
        help_text=_("Maximum 999.9"),
        error_messages={
            "name": {
                "max_length": _("The price must be between 0 and 999.9"),
            },
        },
        max_digits=5,
        decimal_places=2,
...
class ProductSpecificationValue(models.Model):
    """The Product Specification Value Table holds each of the products individial specifications or bespoke features"""
